...
<body
    ...
    <div
        ...
        <h1 class="text-4xl">Register as Teacher!</h1>
        <form class="text-gray-600" name="reg" action="treg.php" method="POST" onsubmit="return checkPassword()">
            ...
            <button type="submit" name="register" class="bg-purple-900 text-base font-bold mb-6 py-2 px-6
                rounded-full text-gray-200">Register</button>
            <h4>Already have an account? <a href="../php/teacherLogin.php"
